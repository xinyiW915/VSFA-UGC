...
import skvideo
skvideo.setFFmpegPath('/mnt/storage/software/apps/ffmpeg-4.3/bin/')
# skvideo.setFFmpegPath("C://Users//um20242//ffmpeg//bin//")
import time
...
if __name__ == "__main__":
    ...
    parser.add_argument('--database', default='YOUTUBE_UGC_1080P_test', type=str,
    ...
    if args.database == 'YOUTUBE_UGC_360P':
        videos_dir = '/mnt/storage/home/um20242/scratch/dataset/ugc-dataset/360P/'
        ...
        videos_dir = '/mnt/storage/home/um20242/scratch/dataset/ugc-dataset/480P/'
        ...
        videos_dir = '/mnt/storage/home/um20242/scratch/dataset/ugc-dataset/720P/'
        ...
        videos_dir = '/mnt/storage/home/um20242/scratch/dataset/ugc-dataset/2160P/'
        ...
        # videos_dir = '/mnt/storage/home/um20242/scratch/dataset/ugc-dataset/2160P/'
        videos_dir = "D://ugc-dataset//ugc//original_videos//2160P/"
        features_dir = './CNN_features_2160P/'
        datainfo = './data/YOUTUBE_UGC_2160P_info.mat'
    elif args.database == 'YOUTUBE_UGC_1080P_test':
        videos_dir = '/user/work/um20242/dataset/ugc-dataset/1080P/'
        # videos_dir = "D://ugc-dataset//ugc//original_videos//1080P/"
        features_dir = './CNN_features_1080P_test/'
        datainfo = './data/YOUTUBE_UGC_1080P_test_info.mat'
    ...
    for i in range(len(dataset)):
        ...
        logging.info(f'score: {current_score}')
        print('Video {}: length {}'.format(i, current_video.shape[0]))
        logging.info(f'video shape: {current_video.shape[0]}')
        features = get_features(current_video, args.frame_batch_size, device)

        elapsed_time = time.time() - start_time
        print(elapsed_time)
        logging.info(f'end time: {elapsed_time}')
        feature_extraction_times.append(elapsed_time)
        print('.................')

        np.save(features_dir + str(i) + '_resnet-50_res5c', features.to('cpu').numpy())
        np.save(features_dir + str(i) + '_score', current_score)

    # Create a DataFrame from the feature_extraction_times list
    df = pd.DataFrame({'VideoName': range(len(feature_extraction_times)), 'RunTime': feature_extraction_times})

    # Save the DataFrame to a CSV file
    df.to_csv(f'./logs/{args.database}_VSFACNN_runtimes.csv', index=False)